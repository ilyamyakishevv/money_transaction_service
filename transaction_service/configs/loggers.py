...
class CustomJsonFormatter(jsonlogger.JsonFormatter):
    def add_fields(self, log_record, record, message_dict):
        ...
        log_record["version"] = app_settings.TRANSACTION_SERVICE_VERSION
        log_record["api-version"] = app_settings.TRANSACTION_API_VERSION


class LogConfig(BaseModel):
    LOGGER_NAME: str = app_settings.TRANSACTION_SERVICE_NAME
...
logger = logging.getLogger(app_settings.TRANSACTION_SERVICE_NAME)
