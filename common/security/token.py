...
access_security = JwtAccessBearerCookie(
    ...
    access_expires_delta=timedelta(minutes=jwt_settings.JWT_ACCESS_TOKEN_EXPIRES),
)
...
refresh_security = JwtRefreshBearer(
    secret_key=jwt_settings.JWT_SECRET_KEY,
    refresh_expires_delta=timedelta(minutes=jwt_settings.JWT_REFRESH_TOKEN_EXPIRES),
)
